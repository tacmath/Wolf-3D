...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/16 17:36:33 by lperron           #+#    #+#             */
/*   Updated: 2020/02/17 16:39:43 by mtaquet          ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
/*
** do we use change var to re render?
*/
...
t_intersection						fast_dda(t_vector2 dir, t_vector2 pos,
										t_map *map);

/*
**  raycaster.c
*/
void								raycaster_col(t_wolf *wolf, int x,
										double angle, t_vector2 dir_ray);
...
void								print_button(t_wolf *wolf, t_button button,
										unsigned int *image);
void								fill_menu_background(t_wolf *wolf,
										int menu);
...
void								print_pack_return(t_wolf *wolf);
void								check_pack_button(t_wolf *wolf,
										int x, int y);
void								print_pack(t_wolf *wolf);
...
int									deal_button(int button, int x, int y,
										t_wolf *wolf);
int									deal_button_release(int button, int x,
										int y, t_wolf *wolf);
...
int									check_button_info(t_pack *pack,
										t_info info);
...
unsigned int						*cut_img(unsigned int *img_old,
								t_point old_size, t_point start, t_point size);
unsigned int						*resize_img(unsigned int *img_old,
								t_point size_old, double ratio);
...
** object.c
*/
void								compute_obj_dist(t_wolf *wolf);
